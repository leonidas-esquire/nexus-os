...
import {
  ArrowLeft, Shield, Download, ExternalLink, Copy, Check,
...
import {
  ...
  getVersionHistory, getSkillDependencies, getSkillUsageExamples,
  getSkillSandboxExamples,
  type Skill, type VersionEntry, type UsageExample, type SandboxExample,
  ...
  return (
    <div className="bg-card/40 border border-border/30 rounded-xl p-6">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        No verified user feedback has been collected for this skill. Ratings and customer quotes are not displayed until they come from a persisted, auditable user-submission system.
      </p>
      <div className="mt-4 rounded-lg border border-border/40 bg-background/40 px-4 py-3 text-xs text-muted-foreground">
        Evaluate the package using its source repository, declared limits, AXIS trust metadata, and your own sandbox tests.
      </div>
    </div>
  );
}
